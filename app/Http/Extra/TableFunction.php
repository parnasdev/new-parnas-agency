...
trait TableFunction
{
    ...
    public function delete($id)
    {
        ...
        $this->dispatchBrowserEvent('toast-message' , ['message' => $this->softDelete ? 'به سطل آشغال انتقال پیدا کرد.' : 'کاملا حذف شد.' , 'icon' => 'success']);
    }
    ...
    public function restore($id)
    {
        ...
        $this->dispatchBrowserEvent('toast-message' , ['message' => ' بازیابی شد.' , 'icon' => 'success']);
    }
    ...
    public function message($id , $force = false , $restore = false)
    {
       if ($this->softDelete) {
           if (!$restore) {
               ...
               $this->dispatchBrowserEvent('message' , ['message' => 'آیا میخواهید بازیابی کنید؟' , 'icon' => 'warning' , 'title' => 'اطمینان دارید؟' , 'btnCText' => 'بله' , 'btnCAText' => 'لغو' , 'event' => 'restore' , 'data' => $id]);
           }
       } else {
