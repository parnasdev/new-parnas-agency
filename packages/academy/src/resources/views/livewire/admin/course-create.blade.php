    ...
    <form wire:submit.prevent="submit">
        <div
            ...
            <div class="c-right box-design bg-white flex-70 px-5 py-15">
                <!--? row form  -->
                <div class="mx-10 m-mx-5 m-mr-5 mb-15">
                    <div class="c-data">
                        <!--! title  -->
                        ...
                        <div class="my-10 ml-10">
                            <div class="d-flex align-items-center justify-content-between flex-wrap flex-100">
                                <!--? input  -->
                                <x-parnas.form-group class="c-input align-items-end flex-48 m-flex-100 mr-9 m-mr-7">
                                    ...
                                    <x-parnas.inputs.text id="title" wire:model.defer="post.title"
                                        placeholder="عنوان دوره را بنویید" wire:change="generateSlug" />
                                    @error('post.title')
                                ...
                                <x-parnas.form-group class="c-input align-items-end flex-48 m-flex-100 mr-9 m-mr-7">
                                    ...
                                    <x-parnas.inputs.text id="slug" wire:model.defer="post.slug" placeholder="نامک"
                            ...
                            <x-parnas.form-group class="align-items-end flex-100 mr-9 m-mr-7 mb-15" wire:ignore>
                                ...
                                <x-parnas.inputs.editor id="description" placeholder="توضیحات خود را بنویسید"
                            ...
                            <div class="pr-10">
                                ...
                                <x-parnas.form-group class="select mt-5 mb-2">
                                    <x-parnas.inputs.select class="form-select" id="post.options.course_status"
                                        name="post.options.course_status" wire:model.defer="post.options.course_status">
                            ...
                            <div class="my-10" x-data="{ course_type: 'spot' }">
                                <label class="radio d-flex align-items-center flex-25 cursor-pointer f-12">
                                    <input class="radio-input" type="radio" name="course_type" x-model="course_type"
                            ...
                            <div class="pr-10">
                                ...
                                <x-parnas.form-group class="select mb-2" wire:ignore>
                                    <x-parnas.inputs.select2 class="form-select" id="teacher" placeholder="مدرس دوره"
                                        wire:model="post.options.teacher">
                                        <x-parnas.inputs.option></x-parnas.inputs.option>
                                        @foreach (\App\Models\User::query()->where('role_id', '!=', 3)->get()
    as $user)
                            ...
                            <x-parnas.form-group class="c-input align-items-end flex-100 mt-10 mr-9 m-mr-7">
                                ...
                                <x-parnas.inputs.text class="form-control" id="post.options.course_period"
                                    placeholder="مدت زمان دوره" name="post.options.course_period"
                ...
                <div class="mx-10 m-mx-5 mb-15">
                    <div class="c-data">
                        ...
                        <!--! data form  -->
                        <div class="my-10">
                            <div class="main-data row-feild d-flex pr-15" x-data="{ manageOffer: 0, offerPrice: '0' }">
                                <!--? input -->
                                <div class="c-input align-items-end flex-30 ml-30">
                                    ...
                                    <input name="post.options.price" class="form-control" id="price"
                                        x-mask:dynamic="$money($input)" wire:model.defer="post.options.price">
                                ...
                                <div class="c-input align-items-end flex-30 ml-30">
                                    ...
                                    <x-parnas.inputs.text class="form-control" name="post.options.offer_price"
                                        x-model="offerPrice" id="offer_price" x-mask:dynamic="$money($input)"
                                        wire:model.defer="post.options.offer_price" />
                                    @error('post.options.offer_price')
                                        <p class="text-danger f-12 pt-7 m-left-auto">{{ $message }}</p>
                                    @enderror
                                </div>
                                {{-- <x-parnas.form-group class="mb-2" x-show="offerPrice !== '0'"> --}}
                                ...
                                {{-- <x-parnas.label class="mb-1" for="post.options.start_offer_day">بعد از چند روز قیمت ویژه --}}
                                {{-- شود؟ --}}
                                {{-- </x-parnas.label> --}}
                                ...
                                {{-- </x-parnas.form-group> --}}
                                {{-- <x-parnas.form-group class="c-input align-items-end flex-30 ml-30" x-show="manageOffer"> --}}
                                {{-- <x-parnas.label class="mb-1" for="post.options.start_offer_day">بعد از چند روز قیمت از --}}
                                {{-- ویژه --}}
                                {{-- نباشد؟ --}}
                                {{-- </x-parnas.label> --}}
                                {{-- <x-parnas.inputs.text type="number" id="post.options.start_offer_day" --}}
                        ...
                        <div class="my-10">
                            <div class="d-flex flex-100">
                                <x-parnas.form-group class="c-input align-items-end flex-48 mr-9 m-mr-7">
                                    ...
                                    <x-parnas.inputs.text id="waranty.title"
                                        wire:model.defer="post.options.waranty.title" placeholder="عنوان گواهی نامه" />
                        ...
                        <div class="pr-10">
                            ...
                            <x-parnas.form-group class="select mb-10" wire:ignore>
                                <x-parnas.inputs.select2 class="form-select" wire:model="post.options.courses"
                                    multiple placeholder="دوره مرتبط" :ajax="true" :api="route('admin.select_post', [
                                        'post_type' => 'academy',
                                        'ignore' => $post->id,
                                    ])">
                                </x-parnas.inputs.select2>
                        ...
                        <div class="pr-10">
                            ...
                            <x-parnas.form-group class="select mb-2" wire:ignore>
                                <x-parnas.inputs.select2 class="form-select" wire:model="post.options.posts"
                                    multiple placeholder="نوشته های مرتبط" :ajax="true" :api="route('admin.select_post', ['post_type' => 'post'])">
                                </x-parnas.inputs.select2>
                            </x-parnas.form-group>
                        </div>
