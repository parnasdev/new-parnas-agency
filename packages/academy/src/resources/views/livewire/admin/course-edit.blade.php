        ...
        <div
            ...
            <div class="c-right box-design bg-white flex-70 px-5 py-15">
                ...
                <div class="mx-10 m-mx-5 mb-15">
                    <div class="c-data">
                        ...
                        <div class="my-10 ml-10">
                            <div class="d-flex justify-content-between flex-wrap flex-100">
                                <!--? input  -->
                                <x-parnas.form-group class="c-input align-items-end flex-48 m-flex-100 mr-9 m-mr-7">
                                    <div class="d-flex justify-content-start m-left-auto pos-relative pt-5 pr-5">
                            ...
                            <x-parnas.form-group class="align-items-end flex-100 mr-9 m-mr-7 mb-2" wire:ignore>
                                ...
                                <x-parnas.inputs.editor id="body" placeholder="متن پیام" wire:model="post.body"/>
                                @error('post.body')
                                <p class="text-danger f-12 pt-7 m-left-auto alert-invalid">{{ $message }}</p>
                                @enderror
                            </x-parnas.form-group>
                            ...
                            <div class="pr-10">
                                ...
                                <x-parnas.form-group class="select my-10 mb-2">
                                    <x-parnas.inputs.select class="form-select" id="post.options.course_status"
                                                            name="post.options.course_status"
                                                            wire:model.defer="post.options.course_status">
                                        <x-parnas.inputs.option value="{{ null }}">
                                            وضعیت دوره
                                        </x-parnas.inputs.option>
                                        @foreach($cStatuses as $_status)
                                            <x-parnas.inputs.option value="{{ $_status->id }}">
                                                {{ $_status->label }}
                                            </x-parnas.inputs.option>
                                        @endforeach
                                    </x-parnas.inputs.select>
                                    @error('post.options.course_status')
                                    <p class="text-danger f-12 pt-7 m-left-auto alert-invalid">{{ $message }}</p>
                                    @enderror
                                </x-parnas.form-group>
                            </div>
                            ...
                            <div class="my-10" x-data="{course_type: @entangle('post.options.course_type')}">
                                <label class="radio d-flex align-items-center flex-25 cursor-pointer f-12">
                                    <input class="radio-input" type="radio" name="course_type"
                                           x-model="course_type"
                                           value="online" wire:model.defer="post.options.course_type">
                                ...
                                <label class="radio d-flex align-items-center flex-25 cursor-pointer f-12">
                                    <input class="radio-input" type="radio" name="course_type"
                                           x-model="course_type"
                                           value="offline" wire:model.defer="post.options.course_type">
                                    <span class="radio-checkmark-box">
                                            <span class="radio-checkmark"></span>
                                        </span>
                                    حضوری
                                </label>
                                <x-parnas.form-group class="c-input mt-10 mb-2" x-show="course_type === 'spot'">
                                    <x-parnas.inputs.text class="form-control" id="course_id"
                                                          placeholder="کد دوره اسپات"
                                                          wire:model.defer="post.options.course_id"/>
                                    @error('post.options.course_id')
                            ...
                            <div class="pr-10">
                                ...
                                <x-parnas.form-group class="select mb-2" wire:ignore>
                                    <x-parnas.inputs.select2 class="form-select" id="teacher"
                                                             placeholder="مدرس دوره"
                                                             wire:model="post.options.teacher">
                            ...
                            <x-parnas.form-group class="c-input align-items-end flex-100 mt-10 mr-9 m-mr-7">
                                ...
                                <x-parnas.inputs.text class="form-control" id="post.options.course_period"
                                                      placeholder="مدت دوره"
                                                      name="post.options.course_period"
                                                      wire:model.defer="post.options.course_period"/>
                                @error('post.options.course_period')
                                <p class="text-danger f-12 pt-7 m-left-auto alert-invalid">{{ $message }}</p>
                                @enderror
                            </x-parnas.form-group>
                        </div>
                ...
                <div class="mx-10 m-mx-5 mb-15">
                    <div class="c-data">
                        ...
                        <div class="my-10 ml-5">
                            <div class="main-data row-feild d-flex flex-wrap pr-15" x-data="{manageOffer: @entangle('post.options.manage_offer') , offerPrice: @entangle('post.options.offer_price')}">
                                <!--? input -->
                                <div class="c-input align-items-end flex-30 ml-30" >
                                    <div class="d-flex justify-content-start m-left-auto pos-relative pt-5 pr-5 pb-5">
                                        <label for="useData" class="d-flex f-12 text-63">
                                            قیمت اصلی
                                            <div class="rx-title title-input pb-10">
                                    ...
                                    <x-parnas.inputs.text name="post.options.price" class="form-control"
                                                          x-mask:dynamic="$money($input)"
                                                          id="price" wire:model.defer="post.options.price"/>
                                    @error('post.options.price')
                                    <p class="text-danger f-12 pt-7 m-left-auto">{{ $message }}</p>
                                    @enderror
                                </div>
                                <!--? input -->
                                <div class="c-input align-items-end flex-30 ml-30">
                                    ...
                                    <x-parnas.inputs.text class="form-control" name="post.options.offer_price" x-model="offerPrice"
                                                          x-mask:dynamic="$money($input)"
                                                          id="offer_price" wire:model.defer="post.options.offer_price"/>
                                    @error('post.options.offer_price')
                                    <p class="text-danger f-12 pt-7 m-left-auto">{{ $message }}</p>
                                    @enderror

                                </div>
                                {{--                            <x-parnas.form-group class="mb-2" x-show="offerPrice !== '0' || offerPrice !== 0 || offerPrice !== null">--}}
                                {{--                                <label class="checkbox f-12">--}}
                                {{--                                    <input class="checkbox-input" x-model="manageOffer" type="checkbox" value="true"--}}
                                {{--                                           wire:model.defer="post.options.manage_offer">--}}
                                {{--                                    <span class="checkbox-checkmark-box">--}}
                                {{--                                    <span class="checkbox-checkmark"></span>--}}
                                {{--                                </span>--}}
                                {{--                                    مدیریت زمان قیمت ویژه--}}
                                {{--                                </label>--}}
                                {{--                            </x-parnas.form-group>--}}

                                {{--                            <x-parnas.form-group class="c-input align-items-end flex-30 ml-30" x-show="manageOffer">--}}
                                {{--                                <x-parnas.label class="mb-1" for="post.options.start_offer_day">بعد از چند روز قیمت ویژه شود؟--}}
                                {{--                                </x-parnas.label>--}}
                                {{--                                <x-parnas.inputs.text type="number" id="post.options.start_offer_day"--}}
                                {{--                                                      name="post.options.start_offer_day"--}}
                                {{--                                                      wire:model.defer="post.options.start_offer_day"/>--}}
                                {{--                                @error('post.options.start_offer_day')--}}
                                {{--                                <p class="text-danger f-12 pt-7 m-left-auto">{{ $message }}</p>--}}
                                {{--                                @enderror--}}
                                {{--                            </x-parnas.form-group>--}}
                                {{--                            <x-parnas.form-group class="c-input align-items-end flex-30 ml-30" x-show="manageOffer">--}}
                                {{--                                <x-parnas.label class="mb-1" for="post.options.start_offer_day">بعد از چند روز قیمت از ویژه--}}
                                {{--                                    نباشد؟--}}
                                {{--                                </x-parnas.label>--}}
                                {{--                                <x-parnas.inputs.text type="number" id="post.options.start_offer_day"--}}
                                {{--                                                      name="post.options.end_offer_day"--}}
                                {{--                                                      wire:model.defer="post.options.end_offer_day"/>--}}
                                {{--                                @error('post.options.offer_price')--}}
                                {{--                                <p class="text-danger f-12 pt-7 m-left-auto">{{ $message }}</p>--}}
                                {{--                                @enderror--}}
                                {{--                            </x-parnas.form-group>--}}
                ...
                <div class="mx-10 m-mx-5 mb-15">
                    <div class="c-data">
                        ...
                        <div class="my-10 ml-10" x-data="{
                    faq: @entangle('faq').defer,
                    addFaq() {
                        ...
                        this.faq.splice(index , 1)
                            ...
                            <table class="table table-sm table-bordered w-100">
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <x-parnas.buttons.button type="button" class="btn bg-success" @click="addFaq()">
                                ...
                                <template x-for="(item , index) in faq">
                                    <tr>
                                        ...
                                        <td>
                                            <x-parnas.buttons.button type="button" class="btn bg-danger"
                ...
                <div class="mx-10 m-mx-5 mb-15">
                    <div class="c-data">
                        ...
                        <div class="my-10 ml-5">
                            <div class="d-flex justify-content-between flex-100">
                                <x-parnas.form-group class="c-input align-items-end flex-48 mr-9 m-mr-7">
                                    <div class="d-flex justify-content-start m-left-auto pos-relative pt-5 pr-5 pb-5">
                                        <label for="useData" class="d-flex f-12 text-63">
                                            عنوان
                                            <div class="rx-title title-input pb-10">
                                    ...
                                    <x-parnas.inputs.text id="waranty.title" wire:model.defer="post.options.waranty.title"
                                                          placeholder="عنوان گواهی نامه"/>
                                    @error('post.options.waranty.title')
                                    <p class="text-danger f-12 pt-7 m-left-auto alert-invalid">{{ $message }}</p>
                                    @enderror
                                </x-parnas.form-group>
                                ...
                                <x-parnas.form-group class="c-input align-items-end flex-48 mr-9 m-mr-7">
                                    ...
                                    <x-parnas.inputs.text id="title" wire:model.defer="post.options.waranty.subtitle"
                                                          placeholder="زیر عنوان گواهی نامه"/>
                                    @error('post.options.waranty.subtitle')
                                    <p class="text-danger f-12 pt-7 m-left-auto alert-invalid">{{ $message }}</p>
                                    @enderror
                                </x-parnas.form-group>
                            </div>
                    ...
                    <div class="c-data">
                        ...
                        <div class="pr-10">
                            ...
                            <x-parnas.form-group class="select mb-10" wire:ignore>
                                <x-parnas.inputs.select2 class="form-select" wire:model="post.options.courses"
                                                         multiple
                                                         :data="$courses"
                                                         placeholder="دوره مرتبط"
                                                         :ajax="true"
                                                         :api="route('admin.select_post' , ['post_type' => 'academy' , 'ignore' => $post->id])">
                                </x-parnas.inputs.select2>
                            </x-parnas.form-group>
                        </div>
                        <div class="pr-10">
                            ...
                            <x-parnas.form-group class="select mb-2" wire:ignore>
                                <x-parnas.inputs.select2 class="form-select" wire:model="post.options.posts"
                                                         multiple
                                                         :data="$posts"
                                                         placeholder="نوشته های مرتبط"
                                                         :ajax="true" :api="route('admin.select_post' , ['post_type' => 'post'])">
                                </x-parnas.inputs.select2>
                            </x-parnas.form-group>
                        </div>


                        <div class="checkbox-list justify-content-start flex-100 my-10">
                            <label class="checkbox f-12">
                                <input class="checkbox-input" type="checkbox" value="1" wire:model.defer="post.pin">
                                <span class="checkbox-checkmark-box">
                                    <span class="checkbox-checkmark"></span>
                                </span>
                                نمایش در بالای لیست
                            ...
                            <label class="checkbox f-12">
                                <input class="checkbox-input" type="checkbox" value="1" wire:model.defer="post.comment">
                                <span class="checkbox-checkmark-box">
                                    <span class="checkbox-checkmark"></span>
                                </span>
                                بستن کامنت
            ...
            <div class="c-left sticky-data flex-28">
                <div>
                            ...
                            <li class="f-12 f-bold">
                                ...
                                <div class="d-flex flex-wrap align-items-center">
                                    <div
                                        class="flex-direction-column align-items-start flex-wrap justify-content-start ml-6">
                                        <button type="button"
                                                wire:click="openFileManager(4 , 1, 'video')"
                                                class="btn border-dotted-2 border-secondary text-white w-100 d-flex align-items-center justify-content-around p-10 radius-5 mb-4">
                                                <svg width="20" height="20" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M15.9375 8.02344L15.9375 23.3601" stroke="#333" stroke-width="2" stroke-linecap="round"/>
                                                    <path d="M23.5898 15.6914L8.29139 15.6914" stroke="#333" stroke-width="2" stroke-linecap="round"/>
                                    ...
                                    @foreach (collect($files)->where('type', 4) as $key => $_file)
                                        @php
                                            $path = str_replace(env('APP_URL'), '', $_file['url']);
                                            $fs = '';
                                            if (\Illuminate\Support\Facades\Storage::disk('uploads')->exists($path)) {
                    ...
                    <!--? select -->
                    <div class="mt-10 p-7 box-design bg-white select-data">
                        <!-- parent -->
                        ...
                        <div class="flex-100 selective-custom justify-content-start mt-7" x-data="{
                            show: false
                        }">
                            <div class="data-in mt-13 mb-15" x-show="show">
                                <livewire:admin.categories.quick-add-category type="2" />
                            </div>
                            <!-- child -->
                            <div class="d-flex align-items-center justify-content-between m-left-auto pos-relative pr-10 pb-5">
                                ...
                                <div class="tooltip c-btn justify-content-end p-3">
                                    <button type="button" class="btn bg-success text-white radius-5" style="padding: 1px" @click="show=!show">
                                        <svg width="20" height="20" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="c-btn justify-content-end pr-8 pt-8">
                            <button class="btn bg-success text-white radius-5">ثبت دوره</button>
                        </div>
                    </div>
                </div>
            </div>
