<div>
    <div
        ...
        <div class="dark-theme box-design bg-white flex-99 m-flex-100 px-5 py-10">
            <div class="">
                <!--? row form  -->
                    ...
                    <div class="">
                        ...
                        <div class="rx-title pb-3">
                            <div class="main-data flex-100 d-flex justify-content-between">
                                ...
                                <!--? group[button]  -->
                                <div class="c-group-btn d-flex flex-wrap justify-content-end">
                                    <div class="c-btn ml-7 pb-5">
                                        <a href="{{ route('admin.courses.index') }}"
                                            class="ancher btn-effect bg-danger text-white radius-5">
                        ...
                        <div class="my-10">
                            ...
                            <div class="p-table p-0">
                                <div class="controller-filters">
                                    ...
                                    <div class="info-data" style="justify-content: flex-end">
                                        ...
                                        <div class="result">
                                            ...
                                            <span class="f-12 px-6">{{ $learnings->total() }}</span>
                                        </div>
                                    </div>
                                </div>
                                <!--! table  -->
                                <div class="controller-table">
                                    <!--? thead -->
                                    <div class="d-thead">
                                        <div class="head flex-8 m-flex-15">
                                            <span class="f-12 f-bold">شناسه</span>
                                        </div>
                                        <div class="head flex-15 m-flex-50">
                                            <span class="f-12 f-bold">نام و نام خانوادگی</span>
                                        </div>
                                        <div class="head flex-20 m-flex-50">
                                            <span class="f-12 f-bold">شماره همراه</span>
                                        </div>
                                        <div class="head flex-11 m-flex-50">
                                            <span class="f-12 f-bold">تاریخ انقضا</span>
                                        </div>
                                        <div class="head flex-35 m-flex-50">
                                            <span class="f-12 f-bold">فصل ها</span>
                                        </div>
                                        <div class="head sticky-table flex-10 m-flex-30">
                                            <span class="f-12 f-bold">عملیات</span>
                                        </div>
                                    </div>
                                    <!--? tdetail  -->
                                    <div class="data" wire:init="loadLearnings">
                                        <!--? child(1)  -->
                                        @forelse($learnings as $learning)
                                            <div class="d-detail">
                                                <div class="detail flex-8 m-flex-15">
                                                    <span class="f-12">{{ $learning->id }}</span>
                                                </div>
                                                <div class="detail flex-15 m-flex-50">
                                                    <span class="f-12">{{ $learning->user->name . ' ' . $learning->user->family }}</span>
                                                </div>
                                                <div class="detail flex-20 m-flex-50">
                                                    <span class="f-12">{{ $learning->user->phone }}</span>
                                                </div>
                                                <div class="detail flex-11 m-flex-50">
                                                    <span
                                                        class="f-12">{{ jdate($learning->expire)->format('Y/m/d H:i') }}</span>
                                                </div>
                                                <div class="detail flex-35 m-flex-50">
                                                    <span
                                                        class="f-12">{{ \Illuminate\Support\Str::limit(implode(', ',\Packages\academy\src\Models\Season::query()->whereIn('id', $learning->season_unlock)->pluck('name')->toArray()) , 34) }}</span>
                                                </div>
                                                <div class="detail d-flex flex-wrap sticky-table flex-10 m-flex-30">
                                                    <button class="d-flex justify-content-center bg-transparent ml-5"
                                                        wire:click="edit({{ $learning->id }})">
                                                    ...
                                                    <button class="d-flex justify-content-center bg-transparent mr-5"
                                                            wire:click="message({{ $learning->id }})">
                                                        <div class="image tooltip d-flex cursor-pointer">
                                            ...
                                            @else
                                                @foreach (range(1, 5) as $item)
                                                    <div class="d-detail placeholder-wave">
                                                        <div class="detail placeholder flex-8 m-flex-15"></div>
                                                        <div class="detail placeholder flex-15 m-flex-50"></div>
                                                        <div class="detail placeholder flex-20 m-flex-50"></div>
                                                        <div class="detail placeholder flex-11 m-flex-50"></div>
                                                        <div class="detail placeholder flex-35 m-flex-50"></div>
                                                        <div class="detail placeholder sticky-table flex-10 m-flex-30"></div>
                                                    </div>
                                                @endforeach
                                            @endif
                                        @endforelse
    ...
    @livewire('learning-season', ['seasons' => $seasons])
</div>
