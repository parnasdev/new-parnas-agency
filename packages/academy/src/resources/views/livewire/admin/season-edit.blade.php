                        ...
                        <div class="my-10">
                            <x-parnas.form-group class="mb-2">
                                ...
                                <div class="d-flex justify-content-start m-left-auto pos-relative pr-10">
                                    <label for="useData" class="d-flex f-14 text-dark">
                                        {{ $season->name }}
                            ...
                            <x-parnas.form-group class="mb-2" wire:ignore>
                                ...
                                <x-parnas.inputs.editor rows="5" class="form-control" name="season.description" id="body"
                                                        wire:model.debounce.1000ms="season.description"/>
                                @error('season.description')
                                <p>{{ $message }}</p>
                                @enderror
                            </x-parnas.form-group>
