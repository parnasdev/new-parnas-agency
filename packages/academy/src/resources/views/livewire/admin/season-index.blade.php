    ...
    <form wire:submit.prevent="submit">
        <div
            ...
            <div class="box-design bg-white flex-99 m-flex-100 px-5 py-10" x-data="{
                ...
                addSeason() {
                    let season = {id : 0 , name : '' , post: 0 , free: 0 , parent: 'null' , description: ''};
                ...
                removeSeason(id) {
                    let index = this.seasons.findIndex(x => x.id === id);
                    ...
                    swalWithBootstrapButtons.fire({
                        title: 'اطمینان دارید؟',
                        text : this.seasons[index].parent === 'null' ? 'اگر سر فصل حذف کنید زیر فصل های و حتی ویدیو های آن هم حذف میشوند!!' : '',
                        icon: 'warning',
                        ...
                        if (result.isConfirmed) {
                            if (this.seasons[index].post > 0) {
                                $wire.deletedSeason(id);
                            }
                    ...
                    <div class="rx-title pb-10">
                        <div class="flex-100 d-flex justify-content-between">
                            ...
                            <div class="c-group-btn d-flex flex-wrap justify-content-start">
                                ...
                                <div class="c-btn ml-7 pb-5">
                                    <a href="{{ route('admin.courses.index') }}" class="ancher btn-effect bg-danger text-white radius-5">
                                        <div class="circle-solid top-right bg-white"></div>
                                        برگشت
                                    </a>
                                </div>
                        ...
                        <div class="p-table p-0">
                            ...
                            <div class="controller-table bg-light">
                                ...
                                <div class="d-thead">
                                    ...
                                    <div class="head flex-44 m-flex-50">
                                        <span class="f-12 f-bold">عنوان</span>
                                    </div>
                                    <div class="head flex-20 m-flex-50">
                                        <span class="f-12 f-bold">نوع فصل</span>
                                    </div>
                                    <div class="head flex-7 m-flex-40">
                                        <span class="f-12 f-bold">رایگان</span>
                                    </div>
                                    <div class="head sticky-table flex-21 m-flex-35">
                                        ...
                                        <div class="main-detail">
                                            ...
                                            <div class="d-detail">
                                                <div class="detail flex-8 m-flex-15">
                                                    <span class="f-12" x-text="season.id"></span>
                                                </div>
                                                <div class="detail flex-44 m-flex-50">
                                                    <x-parnas.form-group class="c-input h-2rem mb-2" style="width: 80%">
                                                        <x-parnas.inputs.text x-model="season.name" class="w-90 m-auto"/>
                                                        @error('seasons.*.name')
                                                        <p>{{ $message }}</p>
                                                        @enderror
                                                    </x-parnas.form-group>
                                                ...
                                                <div class="detail flex-20 m-flex-50">
                                                    <x-parnas.form-group class="select c-s h-2rem" style="width:90%">
                                                        <x-parnas.inputs.select class="form-select form-select-sm"
                                                                                x-model="season.parent">
                                                            <x-parnas.inputs.option x-bind:value="null">سرفصل</x-parnas.inputs.option>
                                                            <template x-for="parent in seasons.filter(s => s.parent === 'null' && s.id !== season.id)">
                                                                <x-parnas.inputs.option x-bind:value="parent.id" x-init="parent.id == season.parent ? $el.setAttribute('selected') : ''"
                                                                                        x-text="parent.name == '' ? 'زیر فصل: بدونه نام' + ' - ' + parent.id : 'زیر فصل:' + parent.name"></x-parnas.inputs.option>
                                                            </template>
                                                        </x-parnas.inputs.select>
                                                        @error('seasons.*.parent')
                                                        <p>{{ $message }}</p>
                                                        @enderror
                                                    </x-parnas.form-group>
                                                </div>
                                                <div class="detail flex-7 m-flex-40">
                                                    <div class="checkbox-list justify-content-start flex-50">
                                                        <label class="checkbox mr-10 f-12">
                                                            <input class="checkbox-input" type="checkbox" value="1" x-model="season.free">
                                                ...
                                                <div class="detail sticky-table flex-21 m-flex-35">
                                                    <a x-bind:href=`/admin/seasons/edit/${season.id}` class="bg-transparent ml-5" x-show="season.post !== 0">
