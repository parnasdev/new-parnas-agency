...
{{--                                    </div>--}}
                                        ...
                                        <div class="box-design bg-white d-flex flex-wrap px-5 py-10 mx-5 mr-20 pr-20 m-pr-10 m-mr-5 m-ml-0 mb-15">
                                            ...
                                            <div class="d-flex flex-100">
                                                <template x-if="input.controlType === 'textbox'">
                                                    <div class="d-flex flex-50 ml-20">
                                                        <div class="select flex-100">
                                                ...
                                                <div class="c-btn d-flex flex-48 mr-10">
                                                    <button class="btn bg-white radius-5 box-shadow-pattern text-danger" @click="inputs.splice(index , 1)">
                                            ...
                                            <template x-if="input.controlType === 'dropdown'">
                                                <div class="d-flex flex-wrap flex-99">
                                                    <div class="d-flex flex-30 ml-20">
                                ...
                                <div class="c-btn flex-100 mt-20" style="justify-content: flex-end">
