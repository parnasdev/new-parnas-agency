                        ...
                        <div class="my-10">
                            ...
                            <div class="p-table p-0">
                                <div class="controller-filters">
                                    ...
                                    <div class="info-data" style="justify-content: flex-end">
                                        ...
                                        <div class="result">
                                            ...
                                            <span class="f-12 px-6">{{ count($forms) > 0 ? $forms->total() : '0' }}</span>
                                        </div>
                                    </div>
                                </div>
                                <!--! table  -->
                                <div class="controller-table">
                                    <!--? thead -->
                                    <div class="d-thead">
                                        <div class="head flex-9 m-flex-20">
                                            <span class="f-12 f-bold">شناسه</span>
                                        </div>
                                        <div class="head flex-43 m-flex-50">
                                            <span class="f-12 f-bold">نام فرم</span>
                                        </div>
                                        <div class="head flex-28 m-flex-50">
                                            <span class="f-12 f-bold">تعداد ارسال شده</span>
                                        </div>
                                        <div class="head sticky-table flex-20 m-flex-45">
                                            <span class="f-12 f-bold">عملیات</span>
                                        </div>
                                    </div>
                                    <!--? tdetail  -->
                                    <div class="data" wire:init="loadForms">
                                        <!--? child(1)  -->
                                        @forelse($forms as $form)
                                            <div class="d-detail">
                                                <div class="detail flex-9 m-flex-20">
                                                    <span class="f-12">{{ $form->id }}</span>
                                                </div>
                                                <div class="detail flex-43 m-flex-50">
                                                    <span class="f-12">{{ $form->name }}</span>
                                                </div>
                                                <div class="detail flex-28 m-flex-50">
                                                    <span class="f-12">{{ collect($form->inboxes)->count() }}</span>
                                                </div>
                                                <div class="detail d-flex flex-wrap sticky-table flex-20 m-flex-45">
                                                    ...
                                                    <a href="{{ route('admin.forms.inboxes' , ['form' => $form->id]) }}"
                                                       class="d-flex justify-content-center bg-transparent ml-5">
                                                        <div class="image tooltip d-flex cursor-pointer">
                                                            ...
                                                            <div class="s-tooltip">
                                                                <span>صندق ورودی</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                    <button wire:click="message({{ $form->id }} , 1)"
                                                            class="d-flex justify-content-center bg-transparent ml-5">
                                                        <div class="image tooltip d-flex cursor-pointer">
                                            ...
                                            @else
                                                @foreach(range(1 , 5) as $item)
                                                    <div class="d-detail placeholder-wave">
                                                        <div class="detail placeholder flex-9 m-flex-20"></div>
                                                        <div class="detail placeholder flex-43 m-flex-50"></div>
                                                        <div class="detail placeholder flex-28 m-flex-50"></div>
                                                        <div class="detail placeholder d-flex flex-wrap sticky-table flex-20 m-flex-45"></div>
                                                    </div>
                                                @endforeach
                                            @endif
                                        @endforelse
