<div>
    <div class="main-data flex-100 d-flex align-items-start m-align-items-stretch justify-content-between mx-10 my-5 m-mx-5">
        ...
        <x-parnas.spinners :full="true" wire:loading
                           wire:target="status , gotoPage , previousPage , nextPage , selectedAction , delete , forceDelete , selected"/>
                            ...
                            <div class="p-table p-0">
                                <div class="controller-filters">
                                    ...
                                    <div class="filters d-flex flex-wrap justify-content-between mb-0">
                                        <div class="c-filters flex-100">
                                            <!--? input  -->
                                            <div class="c-input flex-35 ml-30 mb-8">
                                                ...
                                                <input type="text" wire:model="q" placeholder="عبارت خود را جستجو کنید"/>
                                            </div>
                                        </div>
                                        <!--? select with Search  -->
                                    </div>
                                    ...
                                    <div class="info-data" style="justify-content: flex-end">
                                        ...
                                        <div class="result">
                                            ...
                                            <span class="f-12 px-6">{{ count($discounts) > 0 ? $discounts->total() : '0' }}</span>
                                        </div>
                                    </div>
                                </div>
                                <!--! table  -->
                                <div class="controller-table scroller">
                                    ...
                                    <div class="d-thead">
                                        ...
                                        <div class="head flex-15 m-flex-35">
                                            <span class="f-12 f-bold">کد</span>
                                        </div>
                                        <div class="head flex-14 m-flex-40">
                                            <span class="f-12 f-bold">مقدار</span>
                                        </div>
                                        <div class="head flex-15 m-flex-35">
                                            <span class="f-12 f-bold">تاریخ انقضا</span>
                                        </div>
                                        <div class="head flex-20 m-flex-56">
                                            <span class="f-12 f-bold">تعداد استفاد برای هر کاربر</span>
                                        </div>
                                        <div class="head flex-11 m-flex-56">
                                            <span class="f-12 f-bold">تعداد استفاده</span>
                                        </div>
                                    ...
                                    <!--? tdetail  -->
                                    <div class="data" wire:init="loadDiscounts">
                                        <!--? child(1)  -->
                                        @forelse($discounts as $discount)
                                            <div class="d-detail" x-data="{showDrop: false}">
                                                <div class="detail flex-9 m-flex-15">
                                                    <span class="f-12">{{ $discount->id }}</span>
                                                </div>
                                                <div class="detail flex-15 m-flex-35">
                                                    <div class="f-12">{{ $discount->code }}</div>
                                                </div>
                                                <div class="detail flex-14 m-flex-40">
                                                    <span class="f-12">{{ $discount->is_percent ? $discount->amount . '%' : number_format($discount->amount) }}</span>
                                                </div>
                                                <div class="detail flex-15 m-flex-35">
                                                    <span class="f-12">{{ jdate($discount->expire_date)->format('Y-m-d H:i') }}</span>
                                                </div>
                                                <div class="detail flex-20 m-flex-56">
                                                    <span class="f-12">{{ number_format($discount->use_time) }}</span>
                                                </div>
                                                <div class="detail flex-11 m-flex-56">
                                                    <span class="f-12">{{ number_format($discount->max_user) }}</span>
                                                </div>
                                                <div class="detail d-flex flex-wrap sticky-table flex-15 m-flex-30">
                                                    ...
                                                    <button wire:click="message({{ $discount->id }} ,0)"
                                                            class="d-flex justify-content-center bg-transparent mr-5">
                                                        <div class="image tooltip d-flex cursor-pointer">
                                            ...
                                            @else
                                                @foreach(range(1 , 5) as $item)
                                                    <div class="d-detail placeholder-wave" x-data="{showDrop: false}">
                                                        <div class="detail placeholder flex-9 m-flex-15"></div>
                                                        <div class="detail placeholder flex-15 m-flex-35"></div>
                                                        <div class="detail placeholder flex-14 m-flex-40"></div>
                                                        <div class="detail placeholder flex-15 m-flex-25"></div>
                                                        <div class="detail placeholder flex-20 m-flex-56"></div>
                                                        <div class="detail placeholder flex-11 m-flex-20"></div>
                                                        <div class="detail placeholder d-flex flex-wrap sticky-table flex-15 m-flex-30"></div>
                                                    </div>
                                                @endforeach
                                            @endif
                                        @endforelse
                                ...
                                <div
                                    ...
                                    <!-- ul pagination -->
                                    {{ count($discounts) > 0 ? $discounts->links() : '' }}
                                </div>
                            </div>
                        </div>
                    </div>
