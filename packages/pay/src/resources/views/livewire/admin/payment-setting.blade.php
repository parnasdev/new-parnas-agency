                    ...
                    <div class="mx-10 m-mx-5 mb-15">
                        ...
                        deleteCart(index) {
                            this.cart.items.splice(index , 1)
                                    ...
                                    <div class="flex-100 d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="data">
                                                    ...
                                                    <template x-for="(item , index) in cart.items">
                                                        <div class="main-detail" x-init="$watch('item.cartNumber', value => getBankInfo(index))">
                                                            <!--? child(n)  -->
                                                            <div class="d-detail">
                                                                <div class="detail flex-17 m-flex-55">
                                                                    <x-parnas.form-group class="c-input h-2rem mb-2">
                                                                        <x-parnas.inputs.text
                                                                            x-model="item.cartNumber" style="width:90%;margin:auto"/>
                                                                        @error('setting.atmCart.*.cartNumber')
                                                                        <p>{{ $message }}</p>
                                                                        @enderror
                                                                    </x-parnas.form-group>
                                                                </div>
                                                                <div class="detail flex-15 m-flex-55">
                                                                ...
                                                                <div class="detail flex-17 m-flex-55">
                                                                    <x-parnas.form-group class="c-input h-2rem mb-2">
                                                                        <x-parnas.inputs.text
                                                                            ...
                                                                            x-model="item.bankNumber" style="width:90%;margin:auto"/>
                                                                        @error('setting.atmCart.*.bankNumber')
                                                                        <p>{{ $message }}</p>
                                                                        @enderror
                                                                    </x-parnas.form-group>
                                                                </div>
                                                                <div class="detail flex-23 m-flex-55">
                                                                    <x-parnas.form-group class="c-input h-2rem mb-2">
                                                                        <x-parnas.inputs.text
                                                                            class="form-control form-control-sm"
                                                                            x-model="item.name" style="width:90%;margin:auto"/>
                                                                ...
                                                                <div class="detail flex-17 m-flex-55">
                                                                    <x-parnas.form-group class="c-input h-2rem mb-2">
                                                                        <x-parnas.inputs.text
                                                                            class="form-control form-control-sm"
                                                                            x-model="item.shabaNumber" style="width:90%;margin:auto"/>
                                                                        @error('setting.atmCart.*.shabaNumber')
                                                                        <p>{{ $message }}</p>
                                                                        @enderror
                                                                    </x-parnas.form-group>
                                                                </div>
                                                                <div class="detail sticky-table flex-10 m-flex-20">
                            ...
                            <p class="f-12 mt-2 text-danger"><strong class="pl-5">نکته:</strong>قبل از انتخاب درگاه بانکی جدید لطفا با پشتیبانی
                                تیم پارناس تماس بگیرید</p>
                            <x-parnas.form-group class="c-btn d-flex justify-content-end mt-2">
