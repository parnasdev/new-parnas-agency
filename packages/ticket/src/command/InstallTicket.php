...
namespace Packages\ticket\src\command;
...
class InstallTicket extends Command
{
     ...
     * @var string
     */
    protected $signature = 'install:ticket';
     ...
     * @var string
     */
    protected $description = 'install defaults your ticket';
    ...
    {
        $defaults = config('ticket.defaults');
