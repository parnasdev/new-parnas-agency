<div class="parent-modal-share">
    <div class="title-modal-share">
        <h3>اشتراک‌گذاری</h3>
    </div>
    <div class="t-share-box">
        <span class="text">این کالا را با دوستان خود به اشتراک بگذارید!</span>
        <button class="copy-link-btn" onClick="copyToClipboard()">
            <svg id="Layer_1" height="22" viewBox="0 0 24 24" width="22"
                data-name="Layer 1">
                <path
    ...
    <div class="b-share-box">
        <a href="whatsapp://send?text={{ url()->current() }}"
            data-action="share/whatsapp/share" class="btn-whatsapp">
...
<script>
    function copyToClipboard() {
        ...
        navigator.clipboard.writeText(window.location.href).then(function() {
            ...
            alert('مشکلی در ذخیره رخ داده است.');
        });
