<div>
    <div class="main-data flex-100 d-flex mx-10 m-mx-5 my-5">
        <!--! c-right -->
        <div class="box-design bg-white flex-100 px-5 py-10 ml-7 m-ml-0">
            ...
            <div class="">
                ...
                <div class="mx-10 m-mx-5 mb-15">
                    <div class="c-data">
                            ...
                            <div class="main-data flex-100 d-flex justify-content-between">
                                ...
                                <div class="c-group-btn d-flex flex-wrap justify-content-start">
                                    <div class="c-btn ml-7 pb-5">
                                        <a href="{{ route('admin.categories.create' , ['type' => $type]) }}" class="ancher btn-effect bg-success text-white radius-5">
                        ...
                        <!--! data form  -->
                        <div class="my-10 ml-5" wire:init="loadCategories">
                            <!-- parent -->
                                ...
                                <div class="controller-table">
                                    ...
                                    <div class="d-thead">
                                        ...
                                        <div class="head flex-20 m-flex-30">
                                            <span class="f-12 f-bold">تصویر</span>
                                        </div>
                                        <div class="head flex-26 m-flex-50">
                                            <span class="f-12 f-bold">نام</span>
                                        </div>
                                        <div class="head flex-15 m-flex-50">
                                            <span class="f-12 f-bold">تعداد استفاده شده</span>
                                        </div>
                                        <div class="head flex-8 m-flex-20">
                                            <span class="f-12 f-bold">زبان</span>
                                        </div>
                                        <div class="head sticky-table flex-20 m-flex-40">
                                    ...
                                    <div class="data">
                                        ...
                                        <div class="d-detail">
                                            <div class="detail flex-10 m-flex-15">
                                                <span class="f-12">{{ $category->id }}</span>
                                            </div>
                                            <div class="detail flex-20 m-flex-30">
                                                <img src="{{ $category->files()->first()->url ?? '/images/noPicture.png' }}" alt="" />
                                            </div>
                                            <div class="detail flex-26 m-flex-50">
                                                <span class="f-12">{{ $category->name }}</span>
                                            </div>
                                            <div class="detail flex-15 m-flex-50">
                                                <span class="f-12">{{ $category->posts()->count() }}</span>
                                            </div>
                                            <div class="detail flex-8 m-flex-20">
                                                <span class="f-12">{{ $category->lang }}</span>
                                            </div>
                                            <div class="detail sticky-table flex-20 m-flex-40">
                                                <a class="bg-transparent ml-5" href="{{ route('admin.categories.edit' , ['category' => $category->id , 'type' => $type]) }}">
                                                ...
                                                <button class="bg-transparent ml-5" wire:click="message({{ $category->id }} , 1)">
                                                    <div class="image tooltip d-flex cursor-pointer">
                                            ...
                                            @if(!$readyToLoad)
                                                @foreach(range(1 , 5) as $item)
                                                    <div class="d-detail placeholder-wave">
                                                        <div class="detail flex-10 m-flex-15 placeholder"></div>
                                                        <div class="detail flex-20 m-flex-30 placeholder"></div>
                                                        <div class="detail flex-26 m-flex-50 placeholder"></div>
                                                        <div class="detail flex-15 m-flex-50 placeholder"></div>
                                                        <div class="detail flex-8 m-flex-20 placeholder"></div>
                                                        <div class="detail sticky-table flex-20 m-flex-40 placeholder"></div>
                                                    </div>
                                                @endforeach
                                            @else
