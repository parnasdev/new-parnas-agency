        ...
        <div class="p-info justify-content-between mt-10 pr-7 mr-7 m-ml-10 m-mr-0">
            ...
            <div class="box-design info flex-21 m-flex-60 px-15">
                <div class="text d-flex align-items-center py-10">
                    ...
                    <span class="f-12 text-white pr-7">تعداد دوره ها</span>
                </div>
                <div class="text text-align-left py-10">
                    <span
                        class="f-14 text-white">{{ \App\Models\Post::query()->where('post_type', 'academy')->get()->count() }}</span>
                    <!-- <span class="f-12">مورد</span> -->
                </div>
            </div>
            <!--? child -->
            <div class="box-design info flex-21 m-flex-60 px-15">
                <div class="text d-flex align-items-center py-10">
                    ...
                    <span class="f-12 text-white pr-7">تعداد دوره های خریداری شده</span>
                </div>
                <div class="text text-align-left py-10">
                    <span
                        class="f-14 text-white">{{ \Packages\academy\src\Models\Learning::query()->whereDate('expire', '>=', now())->get()->count() }}</span>
                    <!-- <span class="f-12">مورد</span> -->
                </div>
            </div>
            <!--? child -->
