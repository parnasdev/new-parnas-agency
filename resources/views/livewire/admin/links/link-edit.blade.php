<div>
    <form wire:submit.prevent="submit">
        <div class="main-data flex-100 d-flex align-items-start flex-direction-row-reverse m-direction-column-reverse m-align-items-stretch justify-content-between mx-10 my-5"
            x-data="{
                isDrag: false,
                adding: false,
                moving: true,
            ...
            <!--! c-right  -->
            <div class="c-right box-design bg-white sticky-data flex-27 px-5 py-10">
                <div class="pt-10">
                    <!--? add menu -->
                    <div class="bg-white mx-5 mr-5 m-mr-5">
                        <div class="c-data">
                            <!--! title  -->
                            ...
                            <div class="my-10">
                                ...
                                <div class="our-service mt-10">
                                    <!--? Details -->
                                    <div class="section-details-our-services scroller" style="height: 150px">
                                        <div class="card bg-light radius-10">
                                            ...
                                            <div class="card-paragraph mt-3 card-paragraph-image-odd" id="Card-1">
                                                <div class="card-data d-flex align-items-center flex-wrap pt-5 pl-15 pr-10 pb-10 scroller"
                                                    ...
                                                    <!--? child(n)  -->
                                                    <div class="info-data flex-40" draggable="true"
                                                        data-value="emptyLink" data-id="1">
                                                ...
                                                <div class="card-data d-flex align-items-center flex-wrap py-10 pr-15 scroller"
                                                    ...
                                                    @foreach ($pages as $page)
                                                        <div class="info-data flex-35 ml-10 mb-8" draggable="true"
                                                            ...
                                                            <span class="f-11">{{ $page->title }}</span>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            </div>
            ...
            <!--! c-left -->
            <div class="c-left box-design bg-white flex-70 px-5">
                <div class="pt-20 px-15">
                    <div class="drop-box border-dotted-2 border-info mt-10 m-mx-10"
                    ...
                    <template x-for="(link , index) in getLinks()" :key="link.id">
                        <div class="box-design radius-5 p-10 mb-10" x-data="{ show: false }">
                            <div class="d-flex justify-content-between" @click="show = !show">
                                <span x-text="link.title" class="f-12"></span>
                    ...
                    <!--? select -->
                    <div class="flex-100 select-data d-flex align-items-center pb-10 pt-6">
                        <div class="flex-48 m-flex-45 selective-custom justify-content-start mx-8">
                            ...
                            <div class="select flex-100 m-flex-100 mt-5">
