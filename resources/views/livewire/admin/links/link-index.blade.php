                            ...
                            <div class="main-data flex-100 d-flex justify-content-between">
                                ...
                                <div class="c-group-btn d-flex flex-wrap justify-content-start">
                                    <div class="c-btn ml-7 pb-5">
                                        <a href="{{ route('admin.links.create') }}" class="ancher btn-effect bg-success text-white radius-5">
                            ...
                            <div class="p-table p-0">
                                ...
                                <div class="controller-filters">
                                    ...
                                    <div class="filters d-flex flex-wrap justify-content-between">
                                        <div class="c-filters d-flex justify-content-between flex-100">
                                            <!--? input  -->
                                    ...
                                    <div class="info-data" style="justify-content: flex-end">
                                        ...
                                        <div class="result">
                                            ...
                                            <span class="f-12 px-6">{{ count($links) > 0 ? $links->total() : 0 }}</span>
                                        </div>
                                    </div>
                                </div>
                                <!--! table  -->
                                <div class="controller-table scroller">
                                    <!--? thead -->
                                    <div class="d-thead">
                                        <div class="head flex-9 m-flex-17">
                                            <span class="f-12 f-bold">شناسه</span>
                                        </div>
                                        <div class="head flex-30 m-flex-35">
                                            <span class="f-12 f-bold">نوع</span>
                                        </div>
                                        <div class="head flex-20 m-flex-35">
                                            <span class="f-12 f-bold">زبان</span>
                                        </div>
                                        <div class="head flex-19 m-flex-35">
                                    ...
                                    <!--? tdetail  -->
                                    <div class="data" wire:init="loadLinks">
                                        <!--? child(1)  -->
                                        @forelse($links as $link)
                                            <div class="d-detail">
                                                <div class="detail flex-9 m-flex-17">
                                                    <span class="f-12">{{ $link->id }}</span>
                                                </div>
                                                <div class="detail flex-30 m-flex-35">
                                                    <span class="f-12">{{ $link->type }}</span>
                                                </div>
                                                <div class="detail flex-20 m-flex-35">
                                                    <span class="f-12">{{ $link->lang }}</span>
                                                </div>
                                                <div class="detail flex-19 m-flex-35" x-data>
                                                    <x-parnas.form-group class="checkbox-list flex-50">
                                                        <x-parnas.label class="checkbox f-12">
                                                            <input class="checkbox-input" {{ $link->used ? 'checked' : '' }} type="checkbox" @change="$wire.changeStatus({{ $link->id }})">
                                                ...
                                                <div class="detail sticky-table flex-21 m-flex-35">
                                                    <a href="{{ route('admin.links.edit' , ['link' => $link->id]) }}" class="bg-transparent ml-5">
                                                    ...
                                                    <button class="bg-transparent ml-5" wire:click="message({{ $link->id }} , false)">
                                                        <div class="image tooltip d-flex cursor-pointer">
                                            ...
                                            @else
                                                @foreach(range(1 , 5) as $item)
                                                    <div class="d-detail placeholder-wave">
                                                        <div class="detail placeholder flex-9 m-flex-17"></div>
                                                        <div class="detail placeholder flex-30 m-flex-35"></div>
                                                        <div class="detail placeholder flex-20 m-flex-35"></div>
                                                        <div class="detail placeholder flex-19 m-flex-35"></div>
                                                        <div class="detail placeholder sticky-table flex-21 m-flex-35"></div>
                                                    </div>
                                                @endforeach
                                            @endif
                                        @endforelse
