                        ...
                        <div class="rx-title pb-3">
                            <div class="main-data flex-100 d-flex justify-content-between">
                                ...
                                <div class="c-group-btn d-flex flex-wrap justify-content-start">
                                    <!--? insert data  -->
                                    <div class="c-btn justify-content-end px-8 mb-7">
                                        <button class="ancher btn-effect {{$trash ? 'bg-info': 'bg-danger'}} text-white radius-5" wire:click="showTrash()">
                                            @if($trash)
                                                <div class="circle-solid top-right bg-white"></div> مشاهده صفحه ها
                                            @else
                                                ...
                                                </svg><div class="circle-solid top-right bg-white"></div>
                                                مشاهده صفحه های حذف شده
                                            @endif
                                        </button>
                                    </div>
                                    <div class="c-btn pb-5">
                                        <a href="{{ route('admin.pages.create') }}" class="ancher btn-effect bg-success text-white radius-5">
...
{{--                                                <div class="flex-100 selective-custom justify-content-start mx-8">--}}
{{--                                                    <!-- child -->--}}
{{--                                                    <span class="f-12">بر اساس دسته بندی</span>--}}
...
{{--                                            </div>--}}
                                    ...
                                    <div class="info-data">
                                        ...
                                        <div class="result">
                                            ...
                                            <span class="f-12 px-6">{{ count($posts) > 0 ? $posts->total() : '0' }}</span>
                                        </div>
                                    </div>
                                </div>
                                <!--! table  -->
                                    ...
                                    <div class="data" wire:init="loadPages">
                                        ...
                                        @forelse($posts as $post)
                                            <div class="d-detail">
                                                <div class="detail flex-6 m-flex-10">
                                                    <x-parnas.form-group class="checkbox-list flex-50">
                                                        <x-parnas.label class="checkbox mr-10 f-12">
                                                            <x-parnas.inputs.text class="checkbox-input" type="checkbox" x-ref="checkbox" wire:model.defer="selected"
                                                                                  :value="$post->id"/>
                                                            <span class="checkbox-checkmark-box">
                                                                                <span class="checkbox-checkmark"></span>
                                                                            </span>
                                                ...
                                                <div class="detail sticky-table flex-15 m-flex-50">
                                                    <a href="{{ route('admin.pages.edit' , ['post' => $post->id]) }}" class="bg-transparent ml-5">
                                                    ...
                                                    <a href="{{ route('builder.page' , ['page' => $post->id]) }}" class="bg-transparent ml-5">
                                                        <div class="image tooltip d-flex cursor-pointer">
                                            ...
                                            @else
                                                @foreach(range(1 , 5) as $item)
                                                    <div class="d-detail placeholder-wave">
                                                        ...
                                                        <div class="detail placeholder flex-20 m-flex-45">

                                                        </div>
                                                        <div class="detail placeholder flex-10 m-flex-30">

                                                        </div>
                                                        <div class="detail placeholder flex-8 m-flex-25">

                                                        </div>
                                                        <div class="detail placeholder flex-10 m-flex-35">

                                                        </div>
                                                        <div class="detail placeholder flex-8 m-flex-25">

                                                        </div>
                                                        <div class="detail placeholder flex-7 m-flex-25">

                                                        </div>
                                                        <div class="detail placeholder flex-10 m-flex-45">

                                                        </div>
                                                        <div class="detail placeholder sticky-table flex-15 m-flex-50">
