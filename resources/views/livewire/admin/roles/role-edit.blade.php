                               ...
                               <div class="d-flex align-items-center justify-content-between flex-wrap">
                                   ...
                                   <div class="select-data flex-48 m-flex-50" wire:ignore>
                                       ...
                                       <x-parnas.form-group class="select mb-2">
                                           <x-parnas.inputs.select2 class="form-select mt-3" id="permissions" multiple
                                ...
                                <div class="d-flex align-items-start flex-wrap py-15">
                                    <x-parnas.form-group class="checkbox-list d-flex justify-content-start flex-100 mb-5">
                                ...
                                <p class="f-12 text-danger pr-5">برای وارد کردن نام مسیر با تیم پشتیبانی پارناس تماس حاصل
                                    فرماید</p>
                                ...
                                <div class="c-btn justify-content-end mt-15">
