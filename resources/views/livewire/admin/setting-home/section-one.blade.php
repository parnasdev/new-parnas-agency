    ...
    <form wire:submit.prevent="submit">
        ...
        @if(!is_null($item))
            @foreach($item ?? [] as $key1 => $data)
                <x-parnas.form-group class="flex-100 mb-2">
                    @switch($this->convert($key1)['type'])
                        ...
                        <div class="">
                            ...
                            <div class="c-input flex-99">
                                <x-parnas.inputs.text class="" wire:model="item.{{$key1}}" />
                            </div>
                        </div>
                        @break
                        @case('select')
                        ...
                        <div class="flex-48">
                            ...
                            <div class="d-flex justify-content-start m-left-auto pos-relative pr-10 pb-5">
                                <label for="useData" class="d-flex f-12 text-63">
                                    <x-parnas.label class="f-12">{{ $this->convert($key1)['label'] }}</x-parnas.label>
                                    <div class="rx-title title-input pb-10">
                                        <div class="p-rx">
                                            <div class="rx-border-rectangle-after label-input"></div>
                                        </div>
                        ...
                        @break
                        @case('textarea')
                        <x-parnas.label>{{ $this->convert($key1)['label'] }}</x-parnas.label>
                        <div class="c-input">
