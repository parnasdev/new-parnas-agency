<div>
    <div class="main-data flex-100 d-flex align-items-start m-align-items-stretch justify-content-between mx-10 my-5">
        <x-parnas.spinners :full="true" wire:loading
                           wire:target="status , gotoPage , previousPage , nextPage , changeStatus , selectedAction , delete , forceDelete , selected , perPage , submit"/>
        <!--! c-right  -->
                                ...
                                <div class="controller-filters">
                                    ...
                                    <div class="filters d-flex justify-content-between">
                                        <div class="c-filters flex-100">
                                            <!--? input  -->
                                            <div class="c-input flex-50 ml-30 mb-0">
                                                ...
                                                <input type="text" name="" id="" wire:model="q"
                                    ...
                                    <div class="info-data">
                                        ...
                                        <div class="checkbox-list justify-content-start flex-50">
                                            ...
                                            <div class="select flex-25 c-s h-2rem">
                                        ...
                                        <div class="result">
                                            ...
                                            <span class="f-12 px-6">{{ count($tags) > 0 ? $tags->total() : '0' }}</span>
                                        </div>
                                    </div>
                                </div>
                                <!--! table  -->
                                <div class="controller-table" wire:init="loadTags">
                                    <!--? thead -->
                                    <div class="d-thead">
                                        <div class="head flex-6 m-flex-15"></div>
                                        <div class="head flex-11 m-flex-25">
                                            <span class="f-12 f-bold">شناسه</span>
                                        </div>
                                        <div class="head flex-60 m-flex-60">
                                            <span class="f-12 f-bold">نام</span>
                                        </div>
                                        <div class="head sticky-table flex-22 m-flex-30">
                                    ...
                                    <div class="data">
                                        ...
                                        @forelse($tags as $tag)
                                            <div class="d-detail">
                                                <div class="detail flex-6 m-flex-15">
                                                ...
                                                <div class="detail flex-11 m-flex-25">
                                                    <span class="f-12">{{ $tag->id }}</span>
                                                </div>
                                                <div class="detail flex-60 m-flex-60">
                                                    <span class="f-12">{{ $tag->name }}</span>
                                                </div>
                                                <div class="detail sticky-table flex-22 m-flex-30">
                                            ...
                                            @else
                                                @foreach(range(1 , 5) as $item)
                                                    <div class="d-detail placeholder-wave">
                                                        <div class="detail placeholder flex-6 m-flex-15"></div>
                                                        <div class="detail placeholder flex-11 m-flex-25"></div>
                                                        <div class="detail placeholder flex-60 m-flex-60"></div>
                                                        <div class="detail placeholder sticky-table flex-22 m-flex-30"></div>
                                                    </div>
                                                @endforeach
                                            @endif
        ...
        <div class="c-left sticky-data flex-28">
            <form wire:submit.prevent="submit">
                <div>
                    <div class="p-7 pt-10 bg-white box-design radius-5">
                        <!--? input  -->
                        <div class="c-input align-items-end flex-100">
                            <div class="d-flex justify-content-start m-left-auto pos-relative pr-5">
                                <label for="useData" class="d-flex f-12 text-63">
                                    نام برچسب
                                    <div class="rx-title title-input pb-10">
                            ...
                            <x-parnas.inputs.text placeholder="به عنوان مثال : آموزش" wire:model.defer="nTag.name"/>
                            @error('nTag.name')
                            <span class="text-danger f-12 pt-7 m-left-auto">
                                {{ $message }}
                            </span>
                            @enderror
                        </div>
                        <!--? insert data  -->
                        <div class="c-btn justify-content-end pr-8">
                            <button class="btn bg-success text-white radius-5">ثبت برچسب</button>
                        </div>
                    </div>
                </div>
            </form>
