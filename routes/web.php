...
Route::get('/portifilo', \App\Http\Livewire\Home\PortifiloList::class)->name('portifilos.index');
Route::get('/portifilo/info', \App\Http\Livewire\Home\PortifolioInfo::class)->name('portifilos.show');
